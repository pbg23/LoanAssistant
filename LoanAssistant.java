...
public class LoanAssistant extends JFrame
{
    ...
    Color lightYellow = new Color(73, 183, 66);
            ...
            if (validateDecimalNumber(paymentTextField))
            {
                ...
                if (payment <= (balance * monthlyInterest + 1.0))
                {
                    if (JOptionPane.showConfirmDialog(null, "Minimum payment must be $" +
                                    new DecimalFormat("0.00").format((int)(balance * monthlyInterest + 1.0)) + "\n" + "Do 'want to use the minimum payment?", "Input Error", JOptionPane.YES_NO_OPTION,
...
// will compute payment
    ...
    private boolean validateDecimalNumber() {
        return validateDecimalNumber();
    }
